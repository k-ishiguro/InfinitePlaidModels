function InfinitePlaid_printCurrentStatus(plaid, recorder, itr, time_elapsed, ccc, SHOW_FIG)
% InfinitePlaid_printCurrentStatus(plaid, recorder, itr, time_elapsed,cc,SHOWFIG)
%
% print the current monitor status.
%
% plaid         - MATLAB class intance, InfinitePlaid model.
...
fprintf(1, ['iter=', num2str(itr), ...
    ...
    ' K=', num2str(recorder.KK_history(itr)), ...
