function recorder = InfinitePlaid_recorder_init(cc,TotalSteps)
% recorder = InfinitePlaid_recorder_init(cc,TotalSteps,Z_file_name)
%
% set up the recorder components for Infinite Plaid model. 
%
% input: 
...
% history of "effective" cluster number changes
KK_history = zeros(1, TotalSteps);
