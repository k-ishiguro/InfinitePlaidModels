function BayesPlaid_save(plaid,save_name_prefix,itr, ccc, SHOW_FIG, SAVE_FIG)
% BayesPlaid_save(plaid,save_name_prefix,itr, ccc)
%
...
mat_name = [save_name_prefix, '_BayesPlaid_itr', num2str(itr), '.mat'];
