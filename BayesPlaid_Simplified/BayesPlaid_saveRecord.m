function BayesPlaid_saveRecord(plaid, recorder, save_name_prefix, itr, Z_file_name, SHOW_FIG, SAVE_FIG)
% BayesPlaid_saveRecord(plaid, recorder, save_name_prefix, itr)
%
% save record histories in text file for simpler Bayesian Plaid Model.
%
